...
import ar.gob.ambiente.servicios.gestiontramites.facades.RolFacade;
...
public class MbUsuario implements Serializable{
    ...
    /**
     * Método para ejecutar al iniciar la vista vinculada por el MB
     */
    @PostConstruct
    public void init(){
        ...
        if(!iniciado){
            ...
            while(enume.hasMoreElements()){
                ...
                if(s.substring(0, 2).equals("mb")){
                    if(!s.equals("mbLogin") && !s.equals("mbUsuario")){
    ...
    public String prepareCreate() {
        ...
        if(idApp > 0){
            List<ar.gob.ambiente.servicios.gestiontramites.wsExt.Usuario> lstUsDisp = verUsuariosPorIdApp();
            Iterator itUsDisp = lstUsDisp.listIterator();
            while(itUsDisp.hasNext()){
                ar.gob.ambiente.servicios.gestiontramites.wsExt.Usuario usDisp = (ar.gob.ambiente.servicios.gestiontramites.wsExt.Usuario)itUsDisp.next();
    ...
    **********************/
    ...
    private List<ar.gob.ambiente.servicios.gestiontramites.wsExt.Usuario> verUsuariosPorIdApp(){
        List<ar.gob.ambiente.servicios.gestiontramites.wsExt.Usuario> result;
        try{
            AccesoAppWebService port = service.getAccesoAppWebServicePort();
